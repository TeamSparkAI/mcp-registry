            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 p-8">
              ...
              <div className="ml-13 space-y-3 text-gray-600 dark:text-gray-300">
                ...
                <div className="flex items-start">
                  ...
                  <span><strong>Linting Rules:</strong> Additional best-practice checks and warnings to help improve your server configuration — <Link href="/linter-docs" className="text-blue-600 dark:text-blue-400 hover:underline">view linter docs</Link></span>
                </div>
                <div className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 dark:text-green-400 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
  ...
  "issues": []
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white">Linter Rules</div>
                    <div className="text-sm text-gray-600 dark:text-gray-300">Documentation for server.json linter rules</div>
                  </div>
