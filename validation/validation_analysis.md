...
> **Note:** Search in details by wrapping in square brackets, e.g.: `[required@/repository]`

| Error Type | Instances |
|------------|-----------|
| `required@/repository` | 512 |
| `required@/packages/*` | 148 |
| `schema-missing@/` | 17 |
| `not@/packages/*/version` | 15 |
| `enum@/packages/*/transport/type` | 10 |
| `enum@/packages/*/packageArguments/*/type` | 6 |
| `format@/packages/*/transport/url` | 5 |
| `anyOf@/packages/*/transport` | 5 |
| `enum@/packages/*/environmentVariables/*/format` | 4 |
| `anyOf@/packages/*/packageArguments/*` | 3 |
| `enum@/remotes/*/type` | 2 |
| `format@/remotes/*/url` | 2 |
| `anyOf@/remotes/*` | 2 |
| `required@/packages/*/packageArguments/*` | 1 |
...
> **Note:** Search in details by wrapping in parens, e.g.: `(require-config-for-package)`

| Rule | Instances |
|------|-----------|
| `require-config-for-package` | 690 |
| `prefer-config-for-remote` | 581 |
| `no-template-variables-missing` | 289 |
| `no-value-with-irrelevant-properties` | 189 |
| `no-secret-template` | 151 |
| `no-secret-static-value` | 151 |
| `prefer-dynamic-port` | 99 |
| `require-args-leading-dashes` | 51 |
| `require-valid-default-choice` | 8 |
| `require-valid-choices-format` | 4 |
| `no-unused-variables` | 2 |
...
- Generally seems to be a misunderstanding that "value" is a static value, and not understanding that template/variable feature exists
...
- **`no-secret-template`**: A value containing a template should not be secret (you want to see the template, just the variable should be secret)
