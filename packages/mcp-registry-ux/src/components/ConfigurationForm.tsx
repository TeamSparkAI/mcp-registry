      ...
      if (isReadOnly) {
        return (
          <input
            ...
            value={currentValue}
            readOnly
            className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-gray-50 dark:bg-gray-900 text-gray-600 dark:text-gray-400 cursor-not-allowed"
          />
        );
      }
      ...
      if (format === 'boolean') {
        ...
        return (
          <select
            ...
            className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
          >
      ...
      if (format === 'number') {
        ...
        return (
          <input
            ...
            className={`w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 ${showEyeIcon ? 'pr-10' : 'pr-3'} focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 ${
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-center space-x-2">
          <span className={`text-sm font-mono px-2 py-1 rounded min-w-0 flex-shrink-0 ${
            isRequired ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200' : 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100'
          }`}>
            ...
            <div key={instanceIndex} className="flex items-center space-x-2">
              ...
              {!isFirst && (
                <button
                  ...
                  className="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 flex items-center space-x-1 px-2 py-2 text-sm font-medium self-center"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onClose}
              className="bg-gray-600 dark:bg-gray-700 text-white px-4 py-2 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors text-sm font-medium"
            >
              Cancel
            </button>
          </div>
        ...
        {configuringPackage && (
          <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4 mb-6">
            <h3 className="font-medium text-blue-900 dark:text-blue-200 mb-2">Package Summary</h3>
        ...
        {configuringRemote && (
          <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4 mb-6">
            <h3 className="font-medium text-green-900 dark:text-green-200 mb-2">Remote Summary</h3>
